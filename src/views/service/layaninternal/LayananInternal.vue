    ...
    <div class="max-w-md">
      <a href="https://simdiklat-kemenag.id" target="_blank" class="hover:cursor-pointer">
        ...
        >
          ...
          <div class="flex-shrink-0">
            <img
              src="/public/image/simdiklat.png"
              alt="Simdiklat"
              class="w-35 h-auto object-cover mt-3"
            />
          </div>
        </div>
      </a>
    ...
    <div class="max-w-md">
      ...
      >
        ...
        >
          ...
          <div class="flex-shrink-0">
            <img
              src="/public/image/absensi.png"
              alt="Absensi"
              class="w-27 h-auto object-cover mt-3"
            />
          </div>
        </div>
      </a>
