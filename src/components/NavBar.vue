<template>
  ...
  >
    ...
    <div class="border-t border-gray-100">
      ...
      <div v-if="pengaduanDropdownOpen" ref="pengaduanDropdownContent" class="pl-4 border-t border-gray-100">
        <router-link
          to="/sp4n-lapor"
    ...
    <div v-if="isLoggedIn" class="border-t border-gray-100">
      <router-link
        to="/"
        class="flex items-center space-x-3 px-4 py-3 group"
        @click="mobileOpen = false"
      >
        <img
          :src="user.avatarUrl || '/image/cartoon.png'"
      ...
      <button
        @click="() => { triggerLogoutConfirmation(); mobileOpen = false; }"
